...
class Calculator():
    ...
    def main_frame(self):
        ...
        #TextBox
        self.numberBox = CTkEntry(master=self.window1,width=230,height=50,justify="right",font=CTkFont(family="Arial",size=self.entryBoxFontSize),border_color="black",fg_color="black",text_color="white")
